...
contract EIP20Contract is EIP20Interface {
    ...
    */
    ...
    function EIP20(
        ...
        balances[msg.sender] = 150000000000;               // Give the creator all initial tokens
        totalSupply = 150000000000;                        // Update total supply
        name = "The Unifying Real Dollar";                                   // Set the name for display purposes
        decimals = 3;                            // Amount of decimals for display purposes
        symbol = "TURD";                               // Set the symbol for display purposes
    }
